...
.method static synthetic access$000(Lcom/android/internal/telephony/dataconnection/DctController;)I
    .locals 1
    .param p0    # Lcom/android/internal/telephony/dataconnection/DctController;
...
.method public static makeDctController([Lcom/android/internal/telephony/PhoneProxy;Landroid/os/Looper;)Lcom/android/internal/telephony/dataconnection/DctController;
    .locals 1
    .param p0    # [Lcom/android/internal/telephony/PhoneProxy;
...
.method public doPsAttach(Landroid/net/NetworkRequest;)V
    ...
    invoke-virtual {v1, v10, v11}, Lcom/android/internal/telephony/SubscriptionController;->getPhoneId(J)I
    ...
    invoke-virtual {v6, v5, v9}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->setDataAllowed(ZLandroid/os/Message;)V

    return-void
.end method

.method public doPsDetach(Landroid/net/NetworkRequest;)V
    .locals 8
    .param p1    # Landroid/net/NetworkRequest;

    const-string v3, "DctController"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "doPsDetach for sub:"
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/SubscriptionController;->getCurrentDds()J
    ...
    invoke-virtual {v0, v3, v4}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->setDataAllowed(ZLandroid/os/Message;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v12, "DctController"
    ...
    check-cast v10, Lcom/android/internal/telephony/dataconnection/DctController$SwitchInfo;

    iget v12, v10, Lcom/android/internal/telephony/dataconnection/DctController$SwitchInfo;->mPhoneId:I
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mSubController:Lcom/android/internal/telephony/SubscriptionController;
    ...
    invoke-virtual {v13}, Lcom/android/internal/telephony/SubscriptionController;->getCurrentDds()J

    move-result-wide v14

    invoke-virtual {v12, v14, v15}, Lcom/android/internal/telephony/SubscriptionController;->getPhoneId(J)I
    ...
    const-string v14, "EVENT_ALL_DATA_DISCONNECTED switchInfo :"
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mPhones:[Lcom/android/internal/telephony/PhoneProxy;

    aget-object v12, v12, v8

    move-object/from16 v0, p0

    invoke-virtual {v12, v0}, Lcom/android/internal/telephony/PhoneProxy;->unregisterForAllDataDisconnected(Landroid/os/Handler;)V

    const/4 v12, 0x2

    move-object/from16 v0, p0

    invoke-static {v0, v12, v10}, Landroid/os/Message;->obtain(Landroid/os/Handler;ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v12}, Lcom/android/internal/telephony/PhoneProxy;->getActivePhone()Lcom/android/internal/telephony/Phone;

    move-result-object v6

    move-object/from16 v0, p0

    iget-object v12, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mDdsSwitchPropService:Lcom/android/internal/util/AsyncChannel;

    if-eqz v12, :cond_0

    const-string v12, "Request OemHookDDS service for DDS switch"
    ...
    invoke-virtual {v12, v13, v14, v15}, Lcom/android/internal/util/AsyncChannel;->sendMessageSynchronously(III)Landroid/os/Message;

    const-string v12, "OemHookDDS service finished"
    ...
    iget-object v4, v6, Lcom/android/internal/telephony/PhoneBase;->mDcTracker:Lcom/android/internal/telephony/dataconnection/DcTrackerBase;

    const/4 v12, 0x1

    invoke-virtual {v4, v12, v2}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->setDataAllowed(ZLandroid/os/Message;)V
    ...
    const-string v13, "EVENT_DELAYED_RETRY"
    ...
    const-string v14, " Retry, switchInfo = "
    ...
    invoke-virtual {v12, v13}, Lcom/android/internal/telephony/SubscriptionController;->getSubId(I)[J
    ...
    invoke-virtual {v4, v12, v9}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->setDataAllowed(ZLandroid/os/Message;)V
    ...
    const-string v14, "EVENT_SET_DATA_ALLOWED_DONE  phoneId :"
    ...
    const-string v14, "Failed, switchInfo = "
    ...
    const-string v14, " attempt delayed retry"
    ...
    invoke-virtual {v10}, Lcom/android/internal/telephony/dataconnection/DctController$SwitchInfo;->incRetryCount()V

    invoke-virtual {v10}, Lcom/android/internal/telephony/dataconnection/DctController$SwitchInfo;->isRetryPossible()Z
    ...
    invoke-virtual {v0, v12, v10}, Lcom/android/internal/telephony/dataconnection/DctController;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v0, v12, v14, v15}, Lcom/android/internal/telephony/dataconnection/DctController;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    const-string v13, "Already did max retries, notify failure"

    invoke-static {v12, v13}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v5, Ljava/lang/RuntimeException;

    const-string v12, "PS ATTACH failed"

    invoke-direct {v5, v12}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;)V

    :goto_1
    move-object/from16 v0, p0

    iget-object v12, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mDdsSwitchSerializer:Lcom/android/internal/telephony/dataconnection/DctController$DdsSwitchSerializerHandler;

    invoke-virtual {v12}, Lcom/android/internal/telephony/dataconnection/DctController$DdsSwitchSerializerHandler;->unLock()V

    iget-boolean v12, v10, Lcom/android/internal/telephony/dataconnection/DctController$SwitchInfo;->mIsDefaultDataSwitchRequested:Z

    if-eqz v12, :cond_3

    move-object/from16 v0, p0

    iget-object v12, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mNotifyDefaultDataSwitchInfo:Landroid/os/RegistrantList;
    ...
    invoke-direct {v13, v14, v15, v5}, Landroid/os/AsyncResult;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    const-string v14, "PS ATTACH success = "
    ...
    :cond_3
    iget-boolean v12, v10, Lcom/android/internal/telephony/dataconnection/DctController$SwitchInfo;->mIsOnDemandPsAttachRequested:Z

    if-eqz v12, :cond_4

    move-object/from16 v0, p0

    iget-object v12, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mNotifyOnDemandPsAttach:Landroid/os/RegistrantList;

    new-instance v13, Landroid/os/AsyncResult;

    const/4 v14, 0x0

    iget-object v15, v10, Lcom/android/internal/telephony/dataconnection/DctController$SwitchInfo;->mNetworkRequest:Landroid/net/NetworkRequest;
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mNotifyOnDemandDataSwitchInfo:Landroid/os/RegistrantList;
    ...
    const-string v12, "HALF_CONNECTED: Connection successful with DDS switch service"
    ...
    iput-object v12, v0, Lcom/android/internal/telephony/dataconnection/DctController;->mDdsSwitchPropService:Lcom/android/internal/util/AsyncChannel;
    ...
    const-string v13, "HALF_CONNECTED: Connection failed with DDS switch service, err = "
    ...
    :sswitch_4
    const-string v12, "Connection disconnected with DDS switch service"
...
.method public setDefaultDataSubId(J)V
    ...
    const-string v7, "setDataAllowed subId :"
    ...
    const-string v6, " setDefaultDataSubId,  subId = "
    ...
    invoke-static {v5, v6, p1, p2}, Landroid/provider/Settings$Global;->putLong(Landroid/content/ContentResolver;Ljava/lang/String;J)Z
    ...
    invoke-virtual {v0, v5, v6}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->setDataAllowed(ZLandroid/os/Message;)V
    ...
    const-string v5, "DDS switch"

    invoke-virtual {v0, v5}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->cleanUpAllConnections(Ljava/lang/String;)V
