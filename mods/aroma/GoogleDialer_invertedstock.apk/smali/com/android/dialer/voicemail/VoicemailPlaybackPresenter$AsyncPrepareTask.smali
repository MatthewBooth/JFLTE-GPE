.class Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter$AsyncPrepareTask;
...
# instance fields
.field private mClipPositionInMillis:I
...
.method constructor <init>(Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;I)V
    ...
    iput p2, p0, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter$AsyncPrepareTask;->mClipPositionInMillis:I
...
.method public varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Exception;
    ...
    invoke-interface {v1}, Lcom/android/ex/variablespeed/MediaPlayerProxy;->isReadyToPlay()Z
    ...
    iget-object v2, p0, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter$AsyncPrepareTask;->this$0:Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;
...
.method public bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter$AsyncPrepareTask;->doInBackground([Ljava/lang/Void;)Ljava/lang/Exception;
...
.method public onPostExecute(Ljava/lang/Exception;)V
    ...
    invoke-static {v3, v4}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;->access$2002(Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;Landroid/os/AsyncTask;)Landroid/os/AsyncTask;
    ...
    invoke-static {v3}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;->access$700(Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;)Ljava/util/concurrent/atomic/AtomicInteger;

    move-result-object v3

    invoke-virtual {v3, v0}, Ljava/util/concurrent/atomic/AtomicInteger;->set(I)V

    iget v3, p0, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter$AsyncPrepareTask;->mClipPositionInMillis:I

    const/4 v4, 0x0

    # invokes: Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;->constrain(III)I
    invoke-static {v3, v4, v0}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;->access$1700(III)I
    ...
    invoke-interface {v3, v2}, Lcom/android/ex/variablespeed/MediaPlayerProxy;->seekTo(I)V
    ...
    invoke-interface {v3, v2, v0}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter$PlaybackView;->setClipPosition(II)V
    ...
    invoke-interface {v3}, Lcom/android/ex/variablespeed/MediaPlayerProxy;->start()V
    ...
    invoke-interface {v3}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter$PlaybackView;->playbackStarted()V

    iget-object v3, p0, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter$AsyncPrepareTask;->this$0:Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;

    # getter for: Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    invoke-static {v3}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;->access$2100(Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-interface {v3}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter$PlaybackView;->enableProximitySensor()V
    ...
    invoke-static {v3}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;->access$2200(Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;)Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter$PositionUpdater;

    move-result-object v3

    invoke-virtual {v3, v2, v0}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter$PositionUpdater;->startUpdating(II)V
    :try_end_0
    ...
    invoke-static {v3, v1}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;->access$1400(Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;Ljava/lang/Exception;)V
    ...
    # invokes: Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;->handleError(Ljava/lang/Exception;)V
    invoke-static {v3, p1}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;->access$1400(Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter;Ljava/lang/Exception;)V
...
.method public bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/dialer/voicemail/VoicemailPlaybackPresenter$AsyncPrepareTask;->onPostExecute(Ljava/lang/Exception;)V
