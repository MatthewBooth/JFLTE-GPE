...
.field private mPhoneAccountSettingsPreference:Landroid/preference/Preference;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/phone/CallFeaturesSetting;->mVoicemailRingtoneLookupComplete:Landroid/os/Handler;
    ...
    iput-boolean v1, p0, Lcom/android/phone/CallFeaturesSetting;->mShowVoicemailPreference:Z
...
.method static synthetic access$1600(Lcom/android/phone/CallFeaturesSetting;)Landroid/os/Handler;
    .locals 1
    .param p0    # Lcom/android/phone/CallFeaturesSetting;

    iget-object v0, p0, Lcom/android/phone/CallFeaturesSetting;->mVoicemailRingtoneLookupComplete:Landroid/os/Handler;
...
.method private handleTTYChange(Landroid/preference/Preference;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/phone/CallFeaturesSetting;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
...
.method private initPhoneAccountPreferences()V
    .locals 3

    const-string v1, "phone_account_settings_preference_screen"
    ...
    iput-object v1, p0, Lcom/android/phone/CallFeaturesSetting;->mPhoneAccountSettingsPreference:Landroid/preference/Preference;

    invoke-static {p0}, Landroid/telecom/TelecomManager;->from(Landroid/content/Context;)Landroid/telecom/TelecomManager;

    move-result-object v0

    invoke-virtual {v0}, Landroid/telecom/TelecomManager;->getAllPhoneAccountsCount()I
    ...
    invoke-virtual {v0}, Landroid/telecom/TelecomManager;->getSimCallManagers()Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/android/phone/CallFeaturesSetting;->mPhoneAccountSettingsPreference:Landroid/preference/Preference;
...
.method private initVoiceMailProviders()V
    ...
    const-string v18, "initVoiceMailProviders()"
    ...
    const-string v19, "Found ACTION_ADD_VOICEMAIL. providerToIgnore="
    ...
    const-string v19, "Store loaded VoiceMailProvider. key: "
    ...
    const-string v19, "Set up the first mPreviousVMProviderKey: "
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/phone/CallFeaturesSetting;->mVoicemailRingtoneLookupRunnable:Ljava/lang/Runnable;
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/phone/CallFeaturesSetting;->mShowVoicemailPreference:Z
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    const-string v4, "onPreferenceChange(). preferenece: \""
    ...
    const-string v4, "Voicemail Provider changes from \""
    ...
    const-string v3, "No change is made toward VM provider setting."
    ...
    invoke-direct {p0, v1}, Lcom/android/phone/CallFeaturesSetting;->loadSettingsForVoiceMailProvider(Ljava/lang/String;)Lcom/android/phone/CallFeaturesSetting$VoiceMailProviderSettings;
    ...
    :cond_4
    const-string v3, "Saved preferences found - switching to them"
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    :goto_2
    invoke-virtual {v4, v5, v2}, Landroid/media/AudioManager;->setParameter(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v4}, Lcom/android/phone/CallFeaturesSetting;->startActivityForResult(Landroid/content/Intent;I)V
    ...
    :cond_9
    iget-object v3, p0, Lcom/android/phone/CallFeaturesSetting;->mVoicemailSettingsScreen:Landroid/preference/PreferenceScreen;
...
.method protected onResume()V
    ...
    iput-boolean v11, p0, Lcom/android/phone/CallFeaturesSetting;->mForeground:Z
    ...
    invoke-virtual {p0, v11}, Lcom/android/phone/CallFeaturesSetting;->addPreferencesFromResource(I)V

    invoke-direct {p0}, Lcom/android/phone/CallFeaturesSetting;->initPhoneAccountPreferences()V

    invoke-virtual {p0}, Lcom/android/phone/CallFeaturesSetting;->getPreferenceScreen()Landroid/preference/PreferenceScreen;

    move-result-object v6

    const-string v11, "button_voicemail_key"
    ...
    iput-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mSubMenuVoicemailSettings:Lcom/android/phone/EditPhoneNumberPreference;

    iget-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mSubMenuVoicemailSettings:Lcom/android/phone/EditPhoneNumberPreference;
    ...
    invoke-virtual {v11, p0, v12, p0}, Lcom/android/phone/EditPhoneNumberPreference;->setParentActivity(Landroid/app/Activity;ILcom/android/phone/EditPhoneNumberPreference$GetDefaultNumberListener;)V
    ...
    iput-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mButtonDTMF:Landroid/preference/ListPreference;
    ...
    iput-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mButtonAutoRetry:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mButtonHAC:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mButtonTTY:Landroid/preference/ListPreference;

    const-string v11, "button_voicemail_provider_key"
    ...
    iput-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mVoicemailProviders:Landroid/preference/ListPreference;

    iget-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mVoicemailProviders:Landroid/preference/ListPreference;
    ...
    const-string v11, "button_voicemail_category_key"
    ...
    iput-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mVoicemailSettingsScreen:Landroid/preference/PreferenceScreen;

    const-string v11, "button_voicemail_setting_key"
    ...
    iput-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mVoicemailSettings:Landroid/preference/PreferenceScreen;

    const-string v11, "button_voicemail_notification_ringtone_key"

    invoke-virtual {p0, v11}, Lcom/android/phone/CallFeaturesSetting;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v11

    iput-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mVoicemailNotificationRingtone:Landroid/preference/Preference;
    ...
    iput-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mVoicemailNotificationVibrate:Landroid/preference/CheckBoxPreference;
    ...
    invoke-virtual {v10}, Landroid/telecom/TelecomManager;->isTtySupported()Z
    ...
    :cond_7
    const-string v11, "button_gsm_more_expand_key"
    ...
    const-string v11, "button_fdn_key"
    ...
    :cond_a
    :goto_4
    iget-boolean v11, p0, Lcom/android/phone/CallFeaturesSetting;->mShowVoicemailPreference:Z
    ...
    const-string v12, "ACTION_ADD_VOICEMAIL Intent is thrown. current VM data size: "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v12, p0, Lcom/android/phone/CallFeaturesSetting;->mVMProvidersData:Ljava/util/Map;
    ...
    iget-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mVMProvidersData:Ljava/util/Map;
    ...
    invoke-direct {p0, v11}, Lcom/android/phone/CallFeaturesSetting;->simulatePreferenceClick(Landroid/preference/Preference;)V

    :goto_5
    const/4 v11, 0x0

    iput-boolean v11, p0, Lcom/android/phone/CallFeaturesSetting;->mShowVoicemailPreference:Z
    ...
    iput-boolean v11, p0, Lcom/android/phone/CallFeaturesSetting;->mVMProviderSettingsForced:Z
    ...
    invoke-static {v8, v11}, Lcom/android/phone/CallFeaturesSetting;->migrateVoicemailVibrationSettingsIfNeeded(Landroid/content/SharedPreferences;I)Z

    move-result v11

    if-eqz v11, :cond_10

    iget-object v11, p0, Lcom/android/phone/CallFeaturesSetting;->mVoicemailNotificationVibrate:Landroid/preference/CheckBoxPreference;

    const-string v12, "button_voicemail_notification_vibrate_key"
    ...
    iget-object v12, p0, Lcom/android/phone/CallFeaturesSetting;->mVoicemailRingtoneLookupRunnable:Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, v11, v12}, Lcom/android/phone/CallFeaturesSetting;->onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
