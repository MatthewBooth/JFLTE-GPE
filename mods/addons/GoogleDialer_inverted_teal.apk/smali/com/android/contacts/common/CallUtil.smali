...
.method public static getCallIntent(Ljava/lang/String;Landroid/telecom/PhoneAccountHandle;)Landroid/content/Intent;
    .locals 1
    .param p0    # Ljava/lang/String;
    ...
    invoke-static {p0, v0, p1}, Lcom/android/contacts/common/CallUtil;->getCallIntent(Ljava/lang/String;Ljava/lang/String;Landroid/telecom/PhoneAccountHandle;)Landroid/content/Intent;
...
.method public static getCallIntent(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {v0, p1, v1}, Lcom/android/contacts/common/CallUtil;->getCallIntent(Landroid/net/Uri;Ljava/lang/String;Landroid/telecom/PhoneAccountHandle;)Landroid/content/Intent;
...
.method public static getVideoCallIntent(Ljava/lang/String;Landroid/telecom/PhoneAccountHandle;)Landroid/content/Intent;
    .locals 1
    .param p0    # Ljava/lang/String;
    .param p1    # Landroid/telecom/PhoneAccountHandle;
    ...
    invoke-static {p0, v0, p1}, Lcom/android/contacts/common/CallUtil;->getVideoCallIntent(Ljava/lang/String;Ljava/lang/String;Landroid/telecom/PhoneAccountHandle;)Landroid/content/Intent;
...
.method public static getVideoCallIntent(Ljava/lang/String;Ljava/lang/String;Landroid/telecom/PhoneAccountHandle;)Landroid/content/Intent;
    .locals 2
    .param p0    # Ljava/lang/String;
    .param p1    # Ljava/lang/String;
    .param p2    # Landroid/telecom/PhoneAccountHandle;
    ...
    invoke-static {v0, p1, p2, v1}, Lcom/android/contacts/common/CallUtil;->getCallIntent(Landroid/net/Uri;Ljava/lang/String;Landroid/telecom/PhoneAccountHandle;I)Landroid/content/Intent;
